...
/**
 * The {@link BlugaWHale} is an {@link AbstractArenaAnimal} that eats any animal that
 * has smaller strength than itself, and does not eat grass and Gnat
 * In this world, BlugaWhale has the greatest strength so it will not be eaten by other animals
 */
