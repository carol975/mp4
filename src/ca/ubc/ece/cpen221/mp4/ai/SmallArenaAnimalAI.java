...
/**
 * The SmallArenaAnimalAI evaluates the surrounding of the ArenalAnimal passed
 * and provides corresponding commands.
 * If the ArenaAnimal is dead, it returns a WaitCommand so ArenaAnimal does nothing
 ...
 * moves the ArenaAnimal to a valid and empty adjacent location in the opposite direction of the 
 * animals. 
 * The ArenaAnimal breeds when its MinimumBreedingEnergy is reached.
 * Else the ArenaAnimal moves to an valid and empty adjacent location or idles in the current location
 * 
 * @param world     Subset of the world visible to {@link ArenaAnimal}s.
 * @param animal    The ArenaAnimal waiting for a command
 * @return Command  The corresponding command for the animal
 *
 */

public class SmallArenaAnimalAI extends AbstractAI {
