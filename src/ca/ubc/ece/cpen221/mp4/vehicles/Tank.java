...
public class Tank implements ArenaVehicles {

	private static final int INITIAL_HP = 200;
	private static final int DAMAGE = 100;                   //the damage a vehicle can deal to others
	private static final int COOLDOWN = 8;
	private static final ImageIcon bikeImage = Util.loadImage("tank.gif");
	...
	public int getMovingRange() {
		return 2;  //can only move five step
	}
